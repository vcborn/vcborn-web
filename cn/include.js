...
document.addEventListener("DOMContentLoaded", function () {
  ...
  let head_content =
    ...
    '<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+SC:wght@400;700&Noto+Sans+JP:wght@400;700&display=swap" rel="stylesheet">' +
  ...
  const header_content =
    ...
    '<li><a href="https://blog.vcborn.com">博客</a></li>' +
    "</ul>" +
    "</div>";
  ...
  const footer_content =
    '<div id="footer-inner">' +
    '<div id="footer-top">' +
    '<a href="/cn/"><img src="/images/vcborn-logo.svg" alt="VCborn logo"></a>' +
    '<div id="footer-sns">' +
    ...
    "<ul>" +
    "<li>ABOUT</li>" +
    '<li><a href="/cn/#about">关于 VCborn</a></li>' +
    '<li><a href="/cn/creators">创作者</a></li>' +
    '<li><a href="/join/">加入我们</a></li>' +
    "</ul>" +
    "<ul>" +
    "<li>SERVICES</li>" +
    '<li><a href="/cn/services/vclinux/">VCLinux</a></li>' +
    '<li><a href="/cn/services/reamix/">Reamix</a></li>' +
    "</ul>" +
    "<ul>" +
    "<li>CONTACT</li>" +
    '<li><a href="/contact/">联系我们</a></li>' +
    '<li><a href="/cn/support">支持中心</a></li>' +
    '<li><a href="/cn/presskit">新闻资料</a></li>' +
    "</ul>" +
    "<ul>" +
    "<li>LANGUAGE</li>" +
    ...
    '<div id="footer-last">' +
    "<ul>" +
    '<li><a href="/cn/tos">服务条款</a></li>' +
    '<li><a href="/cn/privacypolicy">隐私政策</a></li>' +
    '<li><a href="/cn/sitepolicy">网站政策</a></li>' +
    '<li>&copy; 2021 <a href="/">VCborn</a></li>' +
    "</ul>" +
    "</div>" +
    "<style>h1, h2, h3, h4, h5, p, li, section, a, button, textarea, ins, select, summary, cite, input {font-family: 'Noto Sans JP', 'Noto Sans SC', sans-serif;}";
